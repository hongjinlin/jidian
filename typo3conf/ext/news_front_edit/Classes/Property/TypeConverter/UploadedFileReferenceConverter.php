<?php
namespace TaoJiang\NewsFrontEdit\Property\TypeConverter;
...
class UploadedFileReferenceConverter extends \TYPO3\CMS\Extbase\Property\TypeConverter\AbstractTypeConverter {
	...
	protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration) {
		...
		$allowedFileExtensions = $configuration->getConfigurationValue('TaoJiang\\NewsFrontEdit\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
		...
		$uploadFolderId = $configuration->getConfigurationValue('TaoJiang\\NewsFrontEdit\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
		$conflictMode = $configuration->getConfigurationValue('TaoJiang\\NewsFrontEdit\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $this->defaultConflictMode;
		$replaceResource = (bool)$configuration->getConfigurationValue('TaoJiang\\NewsFrontEdit\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_REPLACE_RESOURCE) ?: (bool)$configuration->getConfigurationValue('TaoJiang\NewsFrontEdit\Property\TypeConverter\UploadedFileReferenceConverter', self::CONFIGURATION_REPLACE_RESOURCE);
		...
		//debug($replaceResource,'$replaceResource');
		//exit;
	...
	/**
	 * @param File $file
	 * @return \TaoJiang\NewsFrontEdit\Domain\Model\FileReference
	 */
	...
	protected function createFileReferenceFromFalFileReferenceObject(FileReference $fileReference) {
		/** @var $fileReferenceModel \TaoJiang\NewsFrontEdit\Domain\Model\FileReference */
